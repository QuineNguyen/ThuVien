...
<%
    ...
    if (success) {
        // Sau khi lưu thành công, chuyển hướng về trang quản lý mượn tài liệu với thông báo thành công
        response.sendRedirect("gdChinhNV447.jsp?success=1");
    } else {
        // Nếu có lỗi, chuyển hướng về trang quản lý mượn tài liệu với thông báo lỗi
        response.sendRedirect("gdChinhNV447.jsp?err=savefailed");
    }
%>